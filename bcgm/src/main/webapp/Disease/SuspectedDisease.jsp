...
<body>
	...
	<div class="container">
		...
		<div id="navbar" class="navbar-collapse collapse">
			...
			<ul>
			    <li><h4 style="font-weight: 800; padding-left: 41%; color: white; ">疑似疾病诊断结果</h4></li>
			</ul>
		</div>	
	</div>
	</nav>
		...
		<div class="row clearfix">
			...
			<div class="col-sm-8 column" style="font-size: 160%;">
				<table class="table table-striped table-fixed-head" data-table-fixed-head-trigger="20" data-table-fixed-head-top="50" style="margin-top: 4%;">
					<thead>
						<tr>
							<td style="text-align: center;">以下为疾病诊断查询结果：</td>
						</tr>
					</thead>
					<tbody>
					    <c:forEach var="names" items="${names}">
						    <tr>
							    ...
							    <input type="hidden" name="DiseaseName" value="${names}"/><td style="text-align: center;">${names}<button type="submit" class="btn btn-info" style="margin-left: 5%;">查看详情</button></td>
							    </form>
						    </tr>
						</c:forEach>
					</tbody>
